...
int main(int argc,char* argv[])
{
    ...
    {
        char fname[100]="lena.ascii.pgm";
        filename=fname;
    }
        
    int shapeGaus;
    int shapeMedian;
    double** u;   //countour of image
    int Iter;
    double mu;
    double delt;
    ...
    u=Countour(image,Iter,shapeGaus,delt,mu);
    Median(u,image.nx,image.ny,shapeMedian);
    //u=countour(u,nx,ny,5,5,100,1);
    //u=countour(u,nx,ny,20,5,10,1);
    
    Savepgm(u,image.nx,image.ny,3);
